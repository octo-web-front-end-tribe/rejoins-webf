            ...
            <article>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div class="content">
                            <p><a href="https://pix.beta.gouv.fr/" target="_blank">Pix</a> s’adresse à tous les usagers
                                français
                                (élèves, étudiants, professionnels, décrocheurs, demandeurs d’emploi, séniors, citoyens)
                                qui souhaitent
                                mesurer, développer et valoriser leurs compétences numériques.</p>
                            <p>Le service se présente sous la forme d’une plateforme en ligne d’évaluation et de
                                certification des
                                compétences numériques.</p>
                            <p>Le but de Pix est de susciter l’envie de se former tout au long de sa vie en proposant
                                des méthodes
                                d’évaluation innovantes, exigeantes et bienveillantes ainsi que des recommandations de
                                formations
                                ciblées.</p>
                            <p>Pix est développé en Ember.js (front) et Hapi.js / Node.js (API), déployé à la fois sur
                                OVH (API) et
            ...
            <article>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div class="content">
                            <p>Franck est en congés sabatique jusqu'au 2 Juillet pensez à lui si vous cherchez un
                                fronteux !</p>
                        </div>
                    </div>
                </div>
            ...
            <article>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div class="content">
                            <p>Il s'agit de la refonte du <a href="https://www.clubmed.fr/" target="_blank">site B2C</a>,
                                elle a été
                            ...
                            <p>Trois features teams ont été mises en place : le shopping (présentation du produit), le
                                BE (le tunnel
                                de réservation), le PLE (l'espace personnel du GM).</p>
                            <p>Le site est réalisé en react, redux dans le respect des pratiques CRAFT. Nous faisons du
                                rendu côté
                                serveur. Nous maintenons également un server graphql pour faciliter l'intégration à
                                l'API.</p>
            ...
            <article>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div class="content">
                            <p>Développement d’une application web pour permettre aux utilisateurs de faire une demande
                                d’assistance
                                lorsqu’ils tombent en panne, et cela de manière complètement digitale dans le sens où
                                l’intégralité de
                                la demande se fait sur l’application.</p>
                            <p>L’application est scindée en deux parties : une application React / Redux, et un serveur
                                Node.js /
            ...
            <article>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div class="content">
                            <p>Pierre est en congés sabatique jusqu'au 5 Mars pensez à lui si vous cherchez un fronteux
                                !</p>
                        </div>
                    </div>
                </div>
            ...
            <article>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div class="content">
                            <p>Refonte du site éditorial de Roland Garros avec un front en Vue.js (surcouche SSR en
                                Nuxt), un back en
            ...
            <article>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div class="content">
                            <p>Refonte du site &quot;Meetic Affinity&quot; en React pour le desktop et maintenance de la
                                version
            ...
            <article>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div class="content">
                            <p>Migration d’un monolithe Java / JSP, couplé à un mastodonte Oracle, vers une architecture
                                micro-service
